...
module.exports = {
  ...
  "Full Stack Developer": {
    steps: [
      ...
      "Use Git, GitHub, Docker",
      "Practice integration and deployment",
  ...
  "Data Analyst": {
    steps: [
      ...
      "Practice real data analysis cases"
    ],
  ...
  "Product Designer": {
    steps: [
      ...
      "Work with devs to hand off designs",
      "Create prototypes and usability tests",
      "Ship real features"
    ],
  ...
  "Cybersecurity Analyst": {
    steps: [
      ...
      "Use tools like Wireshark & Nessus",
  ...
  "Security Engineer": {
    ...
    skills: ["encryption", "firewall", "penetration testing", "incident response", "siem"]
  }
};
